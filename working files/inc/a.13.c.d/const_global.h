...
RANG_SMALL_BLOCK_DZ1 = (RANG_SMALL_BLOCK_OUT_LAN1 + N_OUT_LAN),
...
RANG_BLOCK_DZ1 = (RANG_BLOCK_OUT_LAN1 + N_OUT_LAN),
RANG_PO_DZ1,
RANG_DZ1,
RANG_PO_AMTZ_DZ1,
RANG_AMTZ_DZ1,
...
#define NUMBER_GENERAL_SIGNAL_FOR_RANG     (33 + N_IN_GOOSE + N_IN_MMS + N_OUT_LAN)
...
*/
/*****************************************/
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_0 (\
     (1u << (RANG_OTKL_VID_ZOVN_ZAHYSTIV - 0))                  \
   | (1u << (RANG_VKL_VV - 0))                                  \
   | (1u << (RANG_OTKL_VV - 0))                                 \
   | (1u << (RANG_VIDKL_VID_ZAKHYSTIV - 0))                     \
   | (1u << (RANG_WORK_BO - 0))                                 \
   | (1u << (RANG_WORK_BV - 0))                                 \
   | (1u << (RANG_1KZ - 0))                                     \
   | (1u << (RANG_2KZ - 0))                                     \
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_1 (\
     (1u << (RANG_PO_DZ1 - 32))                                 \
   | (1u << (RANG_DZ1 - 32))                                    \
   | (1u << (RANG_PO_AMTZ_DZ1 - 32))                            \
   | (1u << (RANG_AMTZ_DZ1 - 32))                               \
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_2 (               \
     (1u << (RANG_PO_DIR_DZ2 - 64))                             \
   | (1u << (RANG_PO_INV_DZ2 - 64))                             \
   | (1u << (RANG_DZ2 - 64))                                    \
   | (1u << (RANG_PO_AMTZ_DZ2 - 64))                            \
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_3 (\
     (1u << (RANG_PO_MTZ1 - 96))                                \
   | (1u << (RANG_PO_MTZN1_VPERED - 96))                        \
   | (1u << (RANG_PO_MTZN1_NAZAD - 96))                         \
   | (1u << (RANG_PO_MTZPN1 - 96))                              \
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_4 (\
     (1u << (RANG_PO_MTZ4 - 128))                                \
   | (1u << (RANG_PO_MTZN4_VPERED - 128))                        \
   | (1u << (RANG_PO_MTZN4_NAZAD - 128))                         \
   | (1u << (RANG_PO_MTZPN4 - 128))                              \
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_5 (                \
     (1u << (RANG_PO_TZNP1_VPERED - 160))                        \
   | (1u << (RANG_PO_TZNP1_NAZAD - 160))                         \
   | (1u << (RANG_TZNP1 - 160))                                  \
   | (1u << (RANG_PO_TZNP2_VPERED - 160))                        \
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_6 (\
     (1u << (RANG_PO_ACHR1 - 192))                               \
   | (1u << (RANG_PO_CHAPV1 - 192))                              \
   | (1u << (RANG_ACHR_CHAPV1 - 192))                            \
   | (1u << (RANG_PO_ACHR2 - 192))                               \
...
#define MASKA_FOR_CONTINUE_GET_DR_ACTINE_WORD_8 (                \
     (1u << (RANG_UMAX2 - 224))                                  \
)
...
#define MASKA_MONITOTYNG_PHASE_SIGNALES_KZ_3 (                 \
     (1u << (RANG_PO_MTZ1 - 96))                               \
   | (1u << (RANG_PO_MTZN1_VPERED - 96))                       \
   | (1u << (RANG_PO_MTZN1_NAZAD - 96))                        \
   | (1u << (RANG_PO_MTZPN1 - 96))                             \
...
#define MASKA_MONITOTYNG_PHASE_SIGNALES_KZ_4 (                 \
     (1u << (RANG_PO_MTZ4 - 128))                              \
   | (1u << (RANG_PO_MTZN4_VPERED - 128))                      \
   | (1u << (RANG_PO_MTZN4_NAZAD - 128))                       \
   | (1u << (RANG_PO_MTZPN4 - 128))                            \
...
#define MAX_FUNCTIONS_IN_IN_GOOSE               (1u << VAGA_MAX_FUNCTIONS_IN_IN_GOOSE)
#define VAGA_MAX_FUNCTIONS_IN_IN_MMS            3
#define MAX_FUNCTIONS_IN_IN_MMS                 (1u << VAGA_MAX_FUNCTIONS_IN_IN_MMS)
#define VAGA_MAX_FUNCTIONS_IN_OUT_LAN           3
#define MAX_FUNCTIONS_IN_OUT_LAN                (1u << VAGA_MAX_FUNCTIONS_IN_OUT_LAN)
